...
const Singup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!validatePassword(password)) {
      newErrors.password = "Password must be at least 8 characters, including letters, numbers, and special characters.";
    }
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center">
      <div
        ...
        style={{ backgroundImage: "url('https://i.pinimg.com/736x/99/e0/3e/99e03ecb9cfd89ef633081123879a9d8.jpg')" ,
          zIndex: "1",
        }}
      ></div>
      ...
      {/* Register Form */}
      <div className="relative z-10 bg-white p-8 shadow-lg rounded-lg max-w-md w-full">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">
            Register as a new user
          </h2>
